...
class SiteInfoController {
    ...
    fun getWritingListByTypeAndAuthor(@RequestParam type: String, @RequestParam author: String): ApiResult<*> {
        return siteInfoService.getWritingListByTypeAndAuthor(type, author)
    }
    ...
    fun setSlide(@RequestPart("title") title: String, @RequestPart("description") description: String, @RequestPart("link") link: String, @RequestPart("base64") base64: String): ApiResult<*> {
        return siteInfoService.setSlide(title, description, link, base64)
    }
